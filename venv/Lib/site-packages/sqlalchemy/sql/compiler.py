...
class SQLCompiler(Compiled):
    ...
    """class-level defaults which can be set at the instance-bak1-bak
    level to define if this Compiled instance-bak1-bak represents
...
class IdentifierPreparer(object):
    ...
    def quote_schema(self, schema, force=None):
        ...
        characters, or is an instance-bak1-bak of :class:`.quoted_name` which includes
        ``quote`` set to ``True``.
    ...
    def quote(self, ident, force=None):
        ...
        quote-necessary characters, or is an instance-bak1-bak of
