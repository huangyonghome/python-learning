...
def between(expr, lower_bound, upper_bound, symmetric=False):
    ...
    :param expr: a column expression, typically a
     ...
     instance-bak1-bak or alternatively a Python scalar expression to be coerced
...
class ClauseElement(Visitable):
    ...
    def compile(self, default, bind=None, dialect=None, **kw):
        ...
        :param dialect: A ``Dialect`` instance-bak1-bak from which a ``Compiled``
...
class ColumnElement(operators.ColumnOperators, ClauseElement):
    ...
    functions with regards to SQL expressions are as follows:
        ...
        * a literal Python value, such as a string, integer or floating
          ...
          resulting :class:`.BindParameter` object is an instance-bak1-bak of
          :class:`_expression.ColumnElement`.
        ...
        * any special object value, typically ORM-level constructs, which
          ...
          :class:`_expression.ColumnElement` instance-bak1-bak.  The primary use of
        ...
        * The Python ``None`` value is typically interpreted as ``NULL``,
          which in SQLAlchemy Core produces an instance-bak1-bak of :func:`.null`.
...
class BindParameter(ColumnElement):
    ...
    def __init__(
        ...
        The return value is an instance-bak1-bak of :class:`.BindParameter`; this
        ...
        :param type\_:
          A :class:`.TypeEngine` class or instance-bak1-bak representing an optional
...
class Case(ColumnElement):
    ...
    def __init__(self, whens, value=None, else_=None):
        ...
        languages.  It returns an instance-bak1-bak of :class:`.Case`.
...
class Cast(ColumnElement):
    ...
    def __init__(self, expression, type_):
        ...
        :func:`.cast` returns an instance-bak1-bak of :class:`.Cast`.
        ...
        type (e.g. :class:`.TypeEngine` class or instance-bak1-bak) with the column
        ...
        :param type\_: A :class:`.TypeEngine` class or instance-bak1-bak indicating
...
def _is_column(col):
    """True if ``col`` is an instance-bak1-bak of
    :class:`_expression.ColumnElement`. """
