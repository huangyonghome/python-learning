...
class Table(DialectKWArgs, SchemaItem, TableClause):
    ...
    object constructs a unique instance-bak1-bak of itself based
        ...
        if key in metadata.tables:
            if not keep_existing and not extend_existing and bool(args):
                raise exc.InvalidRequestError(
                    ...
                    "instance-bak1-bak.  Specify 'extend_existing=True' "
                    "to redefine "
...
class Column(DialectKWArgs, SchemaItem, ColumnClause):
    ...
    def __init__(self, *args, **kwargs):
        ...
        :param type\_: The column's type, indicated using an instance-bak1-bak which
        ...
        :param server_default: A :class:`.FetchedValue` instance-bak1-bak, str, Unicode
        ...
        :param server_onupdate:   A :class:`.FetchedValue` instance-bak1-bak
...
class ColumnDefault(DefaultGenerator):
    ...
    def __init__(self, arg, **kwargs):
         ...
         * A Python callable.  The function will be invoked for each
           ...
           will receive an instance-bak1-bak of the :class:`.ExecutionContext`,
...
class MetaData(SchemaItem):
    ...
    def __init__(
        ...
        :param bind:
          ...
          instance-bak1-bak, these are passed to create_engine() and this MetaData will
    ...
    def reflect(
        ...
        **dialect_kwargs
        ...
        :param only:
          ...
          with a table name and this ``MetaData`` instance-bak1-bak as positional
