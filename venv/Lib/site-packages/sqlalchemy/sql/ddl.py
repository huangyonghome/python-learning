...
class DDLElement(Executable, _DDLCompiles):
    ...
    introduced in :ref:`event_toplevel`.  An instance-bak1-bak of one is
    ...
    def execute_at(self, event_name, target):
        ...
        Links this ``DDLElement`` to a ``Table`` or ``MetaData`` instance-bak1-bak,
        ...
        :param target:
          The Table or MetaData instance-bak1-bak for which this DDLElement will
          be associated with.

        A DDLElement instance-bak1-bak can be linked to any number of schema items.
...
class DDL(DDLElement):
    ...
    a single DDL instance-bak1-bak to handle repetitive tasks for multiple tables.
