...
class _FunctionGenerator(object):
    ...
    :data:`.func` is a special object instance-bak1-bak which generates SQL
    functions based on name-based attributes, e.g.::

        >>> print(func.count(1))
        count(:param_1)

    The returned object is an instance-bak1-bak of :class:`.Function`, and  is a
    ...
    The object returned by a :data:`.func` call is usually an instance-bak1-bak of
    :class:`.Function`.
...
class GenericFunction(util.with_metaclass(_GenericMeta, Function)):
    ...
    a new :class:`.Function` instance-bak1-bak is created automatically,
