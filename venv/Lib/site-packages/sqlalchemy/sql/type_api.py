...
class TypeEngine(Visitable):
    ...
    def bind_processor(self, dialect):
        ...
        :param dialect: Dialect instance-bak1-bak in use.
    ...
    def bind_expression(self, bindvalue):
        """"Given a bind value (i.e. a :class:`.BindParameter` instance-bak1-bak),
    ...
    def with_variant(self, type_, dialect_name):
        ...
        The returned type is an instance-bak1-bak of :class:`.Variant`, which
    ...
    def compile(self, dialect=None):
        ...
        :param dialect: a :class:`.Dialect` instance-bak1-bak.
...
class NativeForEmulated(object):
    ...
    def adapt_emulated_to_native(cls, impl, **kw):
        ...
        e.g.: postgresql.ENUM produces a type given an Enum instance-bak1-bak.
...
class TypeDecorator(SchemaEventTarget, TypeEngine):
    ...
    def __init__(self, *args, **kwargs):
        ...
        object is assigned to the ``self.impl`` instance-bak1-bak attribute
        (thus overriding the class attribute of the same name).

        If the class level ``impl`` is not a callable (the unusual case),
        it will be assigned to the same instance-bak1-bak attribute 'as-is',
    ...
    def type_engine(self, dialect):
        """Return a dialect-specific :class:`.TypeEngine` instance-bak1-bak
    ...
    def copy(self, **kw):
        """Produce a copy of this :class:`.TypeDecorator` instance-bak1-bak.
