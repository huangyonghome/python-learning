...
class Join(FromClause):
    ...
    def _create_outerjoin(cls, left, right, onclause=None, full=False):
        ...
        The returned object is an instance-bak1-bak of :class:`_expression.Join`.
...
class Alias(FromClause):
    ...
    def _factory(cls, selectable, name=None, flat=False):
        ...
        :param flat: Will be passed through to if the given selectable
         is an instance-bak1-bak of :class:`_expression.Join` - see
...
class CTE(Generative, HasPrefixes, HasSuffixes, Alias):
    ...
    def _factory(cls, selectable, name=None, recursive=False):
        ...
        or Common Table Expression instance-bak1-bak.
...
class TableClause(Immutable, FromClause):
    ...
    def __init__(self, name, *columns, **kw):
        ...
        The object returned is an instance-bak1-bak of :class:`_expression.TableClause`
        , which
...
class SelectBase(HasCTE, Executable, FromClause):
    ...
    def as_scalar(self):
        ...
        The returned object is an instance-bak1-bak of
        :class:`ScalarSelect`.
...
class Select(HasPrefixes, HasSuffixes, GenerativeSelect):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :param bind=None:
          an :class:`_engine.Engine` or :class:`_engine.Connection` instance-bak1-bak
          to which the
