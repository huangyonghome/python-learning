...
.. dialect:: mysql+gaerdbms
    ...
    :dbapi: rdbms
    :connectstring: mysql+gaerdbms:///<dbname>?instance-bak1-bak=<instancename>
...
class MySQLDialect_gaerdbms(MySQLDialect_mysqldb):
    ...
    def create_connect_args(self, url):
        ...
        if not _is_dev_environment():
            # 'dsn' and 'instance-bak1-bak' are because we are skipping
            # the traditional google.api.rdbms wrapper
            opts["dsn"] = ""
            opts["instance-bak1-bak"] = url.query["instance-bak1-bak"]
        return [], opts
