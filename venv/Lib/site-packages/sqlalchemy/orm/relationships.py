...
class RelationshipProperty(StrategizedProperty):
    ...
    def __init__(
        ...
        The constructed class is an instance-bak1-bak of
        ...
        :param argument:
          A mapped class, or actual :class:`_orm.Mapper` instance-bak1-bak,
          representing
        ...
        :param secondary:
          ...
          table, and is typically an instance-bak1-bak of :class:`_schema.Table`.
        ...
        :param extension:
          an :class:`.AttributeExtension` instance-bak1-bak, or list of extensions,
        ...
        :param post_update:
          ...
          instance-bak1-bak was UPDATEd as well, although this technically should
    ...
    def _optimized_compare(
        ...
        if state is not None:
            ...
            if state is None or not getattr(state, "is_instance", False):
                raise sa_exc.ArgumentError(
                    "Mapped instance-bak1-bak expected for relationship "
