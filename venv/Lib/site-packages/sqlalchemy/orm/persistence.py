...
def _bulk_insert(
    ...
    if session_transaction.session.connection_callable:
        raise NotImplementedError(
            "connection_callable / per-instance-bak1-bak sharding "
...
def _organize_states_for_save(base_mapper, states, uowtransaction):
    ...
    for state, dict_, mapper, connection in _connections_for_states(
        ...
        # detect if we have a "pending" instance-bak1-bak (i.e. has
        # no instance_key attached to it), and another instance-bak1-bak
            ...
            if not uowtransaction.was_already_deleted(existing):
                if not uowtransaction.is_deleted(existing):
                    raise orm_exc.FlushError(
                        "New instance-bak1-bak %s with identity key %s conflicts "
                        "with persistent instance-bak1-bak %s"
