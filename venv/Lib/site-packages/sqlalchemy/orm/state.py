...
class InstanceState(interfaces.InspectionAttrInfo):
    """tracks state information at the instance-bak1-bak level.
    ...
    mapped instance-bak1-bak, including information such as its current
    ...
    def attrs(self):
        ...
        The returned object is an instance-bak1-bak of :class:`.AttributeState`.
    ...
    def session(self, sessionlib):
        """Return the owning :class:`.Session` for this instance-bak1-bak,
    ...
    @property
    def dict(self):
        """Return the instance-bak1-bak dict used by the object.
    ...
    def __getstate__(self):
        state_dict = {"instance-bak1-bak": self.obj()}
        state_dict.update(
            (k, self.__dict__[k])
            for k in (
                "committed_state",
    ...
    def __setstate__(self, state_dict):
        inst = state_dict["instance-bak1-bak"]
        if inst is not None:
    ...
    def _load_expired(self, state, passive):
        ...
        # instance-bak1-bak state didn't have an identity,
    ...
    def _commit_all(self, dict_, instance_dict=None):
        ...
        to remove all pending state from the instance-bak1-bak.
