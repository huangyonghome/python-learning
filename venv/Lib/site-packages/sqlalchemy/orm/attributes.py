...
class QueryableAttribute(
    ...
    @util.memoized_property
    def parent(self):
        """Return an inspection instance-bak1-bak representing the parent.

        This will be either an instance-bak1-bak of :class:`_orm.Mapper`
...
class AttributeImpl(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :param \callable_:
          ...
          instance-bak1-bak, which produces the "default" values for a scalar or
          collection attribute when it's first accessed, if not present
          already.

        :param trackparent:
          if True, attempt to track if an instance-bak1-bak has a parent attached
    ...
    def hasparent(self, state, optimistic=False):
        ...
        As this function is used to determine if an instance-bak1-bak is an
        *orphan*, instances that were loaded from storage should be
        assumed to not be orphans, until a True/False value for this
        flag is set.

        An instance-bak1-bak attribute that is loaded by a callable function
    ...
    def set_committed_value(self, state, dict_, value):
        """set an attribute value on the given instance-bak1-bak and 'commit' it."""
...
def get_history(obj, key, passive=PASSIVE_OFF):
    ...
    .. note::
        ...
        :class:`.History` for instance-bak1-bak attributes.
...
def set_committed_value(instance, key, value):
    ...
    separate queries, which can then be attached to an instance-bak1-bak
...
def set_attribute(instance, key, value, initiator=None):
    ...
    :param initiator: an instance-bak1-bak of :class:`.Event` that would have
...
def flag_modified(instance, key):
    """Mark an attribute on an instance-bak1-bak as 'modified'.

    This sets the 'modified' flag on the instance-bak1-bak and
...
def flag_dirty(instance):
    """Mark an instance-bak1-bak as 'dirty' without any specific attribute mentioned.
