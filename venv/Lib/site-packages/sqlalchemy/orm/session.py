...
class Session(_SessionClassMethods):
    ...
    def __init__(
        ...
        :param extension: An optional
           :class:`~.SessionExtension` instance-bak1-bak, or a list
    ...
    def bind_mapper(self, mapper, bind):
        ...
        :param mapper: a :class:`_orm.Mapper` object,
         or an instance-bak1-bak of a mapped
    ...
    def get_bind(self, mapper=None, clause=None):
        ...
        The "bind" is usually an instance-bak1-bak of :class:`_engine.Engine`,
        ...
        :param mapper:
          Optional :func:`.mapper` mapped class or instance-bak1-bak of
    ...
    def refresh(
        ...
        """Expire and refresh the attributes on the given instance-bak1-bak.

        A query will be issued to the database and all attributes will be
        refreshed with their current database value.

        Lazy-loaded relational attributes will remain lazily loaded, so that
        the instance-bak1-bak-wide refresh operation will be followed immediately by
        ...
        if (
            ...
            raise sa_exc.InvalidRequestError(
                "Could not refresh instance-bak1-bak '%s'" % instance_str(instance)
            )

    def expire_all(self):
        """Expires all persistent instances within this Session.

        When any attributes on a persistent instance-bak1-bak is next accessed,
        a query will be issued using the
        :class:`.Session` object's current transactional context in order to
        load all expired attributes for the given instance-bak1-bak.   Note that
    ...
    def expire(self, instance, attribute_names=None):
        """Expire the attributes on an instance-bak1-bak.

        Marks the attributes of an instance-bak1-bak as out of date. When an expired
        ...
        :param instance: The instance-bak1-bak to be refreshed.
    ...
    def expunge(self, instance):
        """Remove the `instance-bak1-bak` from this ``Session``.

        This will free all internal references to the instance-bak1-bak.  Cascading
    ...
    def delete(self, instance):
        """Mark an instance-bak1-bak as deleted.
    ...
    def _delete_impl(self, state, obj, head):
        ...
        if head:
            ...
            # the strong reference to the instance-bak1-bak itself is significant here
            cascade_states = list(
    ...
    def merge(self, instance, load=True):
        """Copy the state of a given instance-bak1-bak into a corresponding instance-bak1-bak
        within this :class:`.Session`.

        :meth:`.Session.merge` examines the primary key attributes of the
        source instance-bak1-bak, and attempts to reconcile it with an instance-bak1-bak of the
        same primary key in the session.   If not found locally, it attempts
        to load the object from the database based on primary key, and if
        none can be located, creates a new instance-bak1-bak.  The state of each
        attribute on the source instance-bak1-bak is then copied to the target
        instance-bak1-bak.  The resulting target instance-bak1-bak is then returned by the
        method; the original source instance-bak1-bak is left unmodified, and
    ...
    def _merge(
        ...
        if state is not merged_state:
            ...
            # are not instance-bak1-bak-specific (which they should not be)
    ...
    def __contains__(self, instance):
        """Return True if the instance-bak1-bak is associated with this session.

        The instance-bak1-bak may be pending or persistent within the Session for a
        result of True.
    ...
    def is_modified(self, instance, include_collections=True, passive=None):
        r"""Return ``True`` if the given instance-bak1-bak has locally
        modified attributes.

        This method retrieves the history for each instrumented
        attribute on the instance-bak1-bak and performs a comparison of the current
        value to its previously committed value, if any.

        It is in effect a more expensive and accurate
        version of checking for the given instance-bak1-bak in the
        ...
        * Scalar attributes may not have recorded the previously set
        ...
        :param instance: mapped instance-bak1-bak to be tested for pending changes.
        :param include_collections: Indicates if multivalued collections
         should be included in the operation.  Setting this to ``False`` is a
         way to detect only local-column based properties (i.e. scalar columns
         or many-to-one foreign keys) that would result in an UPDATE for this
         instance-bak1-bak upon flush.
    ...
    def dirty(self):
        ...
        mark an instance-bak1-bak as 'dirty' and place it in this set, even if
        ...
        To check if an instance-bak1-bak has actionable net changes to its
...
def make_transient(instance):
    """Alter the state of the given instance-bak1-bak so that it is :term:`transient`.
    ...
    The given mapped instance-bak1-bak is assumed to be in the :term:`persistent` or
...
def make_transient_to_detached(instance):
    """Make the given transient instance-bak1-bak :term:`detached`.
    ...
    All attribute history on the given instance-bak1-bak
    will be reset as though the instance-bak1-bak were freshly loaded
    ...
    into the "key" of the instance-bak1-bak.
...
def object_session(instance):
    """Return the :class:`.Session` to which the given instance-bak1-bak belongs.
