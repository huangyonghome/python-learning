...
class Mapper(InspectionAttr):
    ...
    def __init__(
        ...
        :param batch: Defaults to ``True``, indicating that save operations
           ...
           that an instance-bak1-bak will be fully saved before saving the next
           instance-bak1-bak.  This is used in the extremely rare case that a
        ...
        :param extension: A :class:`.MapperExtension` instance-bak1-bak or
        ...
        :param polymorphic_on: Specifies the column, attribute, or
          ...
          looks like::
                ...
                def set_identity(instance-bak1-bak, *arg, **kw):
                    mapper = object_mapper(instance-bak1-bak)
                    instance-bak1-bak.discriminator = mapper.polymorphic_identity
        ...
        # the object instance-bak1-bak for that row.
    ...
    Typically is an instance-bak1-bak of :class:`_schema.Table` or
    ...
    Typically an instance-bak1-bak of :class:`_schema.Table`, :class:`_expression.Join`
    , or
    :class:`_expression.Alias`.
    ...
    This attribute is normally a :class:`_schema.Column` instance-bak1-bak but
    ...
    def _configure_polymorphic_setter(self, init=False):
        ...
        upon instance-bak1-bak construction, also if applicable.  This
        routine will run when an instance-bak1-bak is created.
        ...
        if self.polymorphic_on is not None:
            ...
            for mapper in self.iterate_to_root():
                ...
                if mapper.polymorphic_on is not None:
                    ...
                    # instance-bak1-bak's mapper is used so is portable to subclasses.
                    if self.polymorphic_on is not None:
    ...
    def _adapt_inherited_property(self, key, prop, init):
        if not self.concrete:
            ...
            # can't use this at the instance-bak1-bak level since we are a concrete
    ...
    def _property_from_column(self, key, prop):
        ...
        if not expression._is_column(column):
            raise sa_exc.ArgumentError(
                "%s=%r is not an instance-bak1-bak of MapperProperty or Column"
                % (key, prop)
            )
    ...
    def attrs(self):
        ...
        its key name.  For instance-bak1-bak, the mapper for a
        ...
        .. warning::
            ...
            instance-bak1-bak of :class:`.OrderedProperties`.  This is
    ...
    def identity_key_from_row(self, row, identity_token=None, adapter=None):
        ...
        :param row: A :class:`.RowProxy` instance-bak1-bak.  The columns which are
    ...
    def identity_key_from_instance(self, instance):
        """Return the identity key for the given instance-bak1-bak, based on
        its primary key attributes.

        If the instance-bak1-bak's state is expired, calling this method
        will result in a database check to see if the object has been deleted.
        If the row no longer exists,
        :class:`~sqlalchemy.orm.exc.ObjectDeletedError` is raised.

        This value is typically also found on the instance-bak1-bak state under the
        attribute name `key`.
...
def configure_mappers():
    ...
    into an instance-bak1-bak, as well as when the :meth:`.Session.query` method
    is used.
...
def reconstructor(fn):
    ...
    method that will be called by the ORM after the instance-bak1-bak has been
    loaded from the database or otherwise reconstituted.

    The reconstructor will be invoked with no arguments.  Scalar
    (non-collection) database-mapped attributes of the instance-bak1-bak will
