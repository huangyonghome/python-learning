...
types or a function that returns an instance-bak1-bak.  Collection classes are
inspected and instrumented during the mapper compilation phase.  The
collection_class callable will be executed once to produce a specimen
instance-bak1-bak, and the type of that specimen will be instrumented.  Functions that
...
class collection(object):
    ...
    def linker(fn):
        ...
        the instance-bak1-bak.  A single argument is passed: the collection adapter
...
def bulk_replace(values, existing_adapter, new_adapter, initiator=None):
    ...
    fired for any instance-bak1-bak not present in the ``existing_adapter``.  Any
