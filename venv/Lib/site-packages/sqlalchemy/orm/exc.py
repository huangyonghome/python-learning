...
class DetachedInstanceError(sa_exc.SQLAlchemyError):
    ...
    mapped instance-bak1-bak that is detached."""

    code = "bhk3"


class UnmappedInstanceError(UnmappedError):
    """An mapping operation was requested for an unknown instance-bak1-bak."""
    ...
    def __init__(self, base, obj, msg=None):
        if not msg:
            try:
                ...
                msg = (
                    "Class %r is mapped, but this instance-bak1-bak lacks "
                    "instrumentation.  This occurs when the instance-bak1-bak "
                ...
                if isinstance(obj, type):
                    msg += (
                        "; was a class (%s) supplied where an instance-bak1-bak was "
