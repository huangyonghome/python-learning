...
class CompositeProperty(DescriptorProperty):
    ...
    def __init__(self, class_, *attrs, **kwargs):
        ...
        :param class\_:
          ...
          will produce a new instance-bak1-bak of the composite object given the
        ...
        :param deferred:
          ...
          first accessed on an instance-bak1-bak.  See also
        ...
        :param extension:
          an :class:`.AttributeExtension` instance-bak1-bak,
    ...
    def __init__(self):
        ...
        def warn():
            raise AttributeError(
                ...
                "attribute %r at the instance-bak1-bak level.  Add "
...
class SynonymProperty(DescriptorProperty):
    def __init__(
        ...
        :param descriptor: a Python :term:`descriptor` that will be used
          ...
          accessed at the instance-bak1-bak level.
