...
and attributes.py which establish per-instance-bak1-bak and per-class-attribute
...
class ClassManager(dict):
    ...
    def manage(self):
        """Mark this instance-bak1-bak as the manager for its class."""
    ...
    def state_getter(self):
        """Return a (instance-bak1-bak) -> InstanceState callable.
...
def is_instrumented(instance, key):
    """Return True if the given attribute on the given instance-bak1-bak is
