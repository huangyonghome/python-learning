    ...
    if instance is not None:
        ...
        if state.expired:
            if not passive & attributes.SQL_OK:
                ...
                # this mode is used within a flush and the instance-bak1-bak's
...
def _instance_processor(
    ...
    if refresh_state:
        ...
        if refresh_identity_key is None:
            ...
            # on a non-instance-bak1-bak-key instance-bak1-bak; this is meant to only
    ...
    def _instance(row):
        ...
        if refresh_identity_key:
            ...
            if instance is not None:
                ...
                # create a new instance-bak1-bak
                ...
                # attach instance-bak1-bak to session.
...
def load_scalar_attributes(mapper, state, attribute_names):
    ...
    # if instance-bak1-bak is pending, a refresh operation
