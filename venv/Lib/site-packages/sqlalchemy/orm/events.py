...
class InstanceEvents(event.Events):
    ...
    * the :class:`_orm.Mapper` class itself and the :func:`.mapper`
    ...
    are more specific to the instance-bak1-bak and its instrumentation,
    ...
    :param raw=False: When True, the "target" argument passed
       ...
       instance-bak1-bak's :class:`.InstanceState` management
       object, rather than the mapped instance-bak1-bak itself.
    ...
    def first_init(self, manager, cls):
        """Called when the first instance-bak1-bak of a particular mapping is called.
    ...
    def init(self, target, args, kwargs):
        """Receive an instance-bak1-bak when its constructor is called.
        ...
        :param target: the mapped instance-bak1-bak.  If
         the event is configured with ``raw=True``, this will
         instead be the :class:`.InstanceState` state-management
         object associated with the instance-bak1-bak.
    ...
    def init_failure(self, target, args, kwargs):
        """Receive an instance-bak1-bak when its constructor has been called,
    ...
    def load(self, target, context):
        """Receive an object instance-bak1-bak after it has been created via
        ``__new__``, and after initial attribute population has
        occurred.

        This typically occurs when the instance-bak1-bak is created based on
        incoming result rows, and is only called once for that
        instance-bak1-bak's lifetime.

        .. warning::

            During a result-row load, this event is invoked when the
            first row received for this instance-bak1-bak is processed.  When using
            ...
            * accessing attributes on a joined-inheritance subclass that
            ...
            event is called::
                ...
                def on_load(instance-bak1-bak, context):
                    instance-bak1-bak.some_unloaded_attribute
    ...
    def refresh(self, target, context, attrs):
        """Receive an object instance-bak1-bak after one or more attributes have
    ...
    def refresh_flush(self, target, flush_context, attrs):
        """Receive an object instance-bak1-bak after one or more attributes that
    ...
    def expire(self, target, attrs):
        """Receive an object instance-bak1-bak after its attributes or some subset
        have been expired.
    ...
    def pickle(self, target, state_dict):
        """Receive an object instance-bak1-bak when its associated state is
        being pickled.
    ...
    def unpickle(self, target, state_dict):
        """Receive an object instance-bak1-bak after its associated state has
        been unpickled.
...
class MapperEvents(event.Events):
    ...
    * the :class:`_orm.Mapper` class itself and the :func:`.mapper`
    ...
    def before_insert(self, mapper, connection, target):
        """Receive an object instance-bak1-bak before an INSERT statement
        is emitted corresponding to that instance-bak1-bak.

        This event is used to modify local, non-object related
        attributes on the instance-bak1-bak before an INSERT occurs, as well
        ...
        :param connection: the :class:`_engine.Connection` being used to
         emit INSERT statements for this instance-bak1-bak.  This
         provides a handle into the current transaction on the
         target database specific to this instance-bak1-bak.
        :param target: the mapped instance-bak1-bak being persisted.  If
         the event is configured with ``raw=True``, this will
         instead be the :class:`.InstanceState` state-management
         object associated with the instance-bak1-bak.
    ...
    def after_insert(self, mapper, connection, target):
        """Receive an object instance-bak1-bak after an INSERT statement
        is emitted corresponding to that instance-bak1-bak.

        This event is used to modify in-Python-only
        state on the instance-bak1-bak after an INSERT occurs, as well
        as to emit additional SQL statements on the given
        connection.
    ...
    def before_update(self, mapper, connection, target):
        """Receive an object instance-bak1-bak before an UPDATE statement
        is emitted corresponding to that instance-bak1-bak.

        This event is used to modify local, non-object related
        attributes on the instance-bak1-bak before an UPDATE occurs, as well
        as to emit additional SQL statements on the given
        connection.
        ...
        statement will be issued. This means that an instance-bak1-bak
        ...
        *not* a guarantee that an UPDATE statement will be
        ...
        ``object_session(instance-bak1-bak).is_modified(instance-bak1-bak,
        ...
        :param mapper: the :class:`_orm.Mapper` which is the target
         of this event.
        :param connection: the :class:`_engine.Connection` being used to
         emit UPDATE statements for this instance-bak1-bak.  This
         provides a handle into the current transaction on the
         target database specific to this instance-bak1-bak.
        :param target: the mapped instance-bak1-bak being persisted.  If
         the event is configured with ``raw=True``, this will
    ...
    def after_update(self, mapper, connection, target):
        """Receive an object instance-bak1-bak after an UPDATE statement
        is emitted corresponding to that instance-bak1-bak.

        This event is used to modify in-Python-only
        state on the instance-bak1-bak after an UPDATE occurs, as well
        as to emit additional SQL statements on the given
        connection.
    ...
    def before_delete(self, mapper, connection, target):
        """Receive an object instance-bak1-bak before a DELETE statement
        is emitted corresponding to that instance-bak1-bak.
        ...
        :param mapper: the :class:`_orm.Mapper` which is the target
         of this event.
        :param connection: the :class:`_engine.Connection` being used to
         emit DELETE statements for this instance-bak1-bak.  This
         provides a handle into the current transaction on the
         target database specific to this instance-bak1-bak.
        :param target: the mapped instance-bak1-bak being deleted.  If
         the event is configured with ``raw=True``, this will
         instead be the :class:`.InstanceState` state-management
         object associated with the instance-bak1-bak.
        :return: No return value is supported by this event.
    ...
    def after_delete(self, mapper, connection, target):
        """Receive an object instance-bak1-bak after a DELETE statement
        has been emitted corresponding to that instance-bak1-bak.
...
class SessionEvents(event.Events):
    ...
    :param raw=False: When True, the "target" argument passed
       ...
       objects will be the instance-bak1-bak's :class:`.InstanceState` management
       object, rather than the mapped instance-bak1-bak itself.
    ...
    def after_flush(self, session, flush_context):
        ...
        as the history settings on instance-bak1-bak attributes.
    ...
    def before_attach(self, session, instance):
        """Execute before an instance-bak1-bak is attached to a session.
    ...
    def after_attach(self, session, instance):
        """Execute after an instance-bak1-bak is attached to a session.
    ...
    def transient_to_pending(self, session, instance):
        ...
        :param instance: the ORM-mapped instance-bak1-bak being operated upon.
    ...
    def loaded_as_persistent(self, session, instance):
        ...
        the event here is linkable to a :class:`.Session` class or instance-bak1-bak,
...
class AttributeEvents(event.Events):
    ...
    def append(self, target, value, initiator):
        ...
        :param target: the object instance-bak1-bak receiving the event.
        ...
        :param value: the value being appended.  If this listener
          ...
          replaces it.
        :param initiator: An instance-bak1-bak of :class:`.attributes.Event`
...
class QueryEvents(event.Events):
    ...
    def before_compile_update(self, query, update_context):
        ...
        :param query: a :class:`_query.Query` instance-bak1-bak; this is also
