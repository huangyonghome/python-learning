...
def track_cascade_events(descriptor, prop):
    ...
    def append(state, item, initiator):
        ...
        # an instance-bak1-bak is appended to the list of another instance-bak1-bak
    ...
    def set_(state, newvalue, oldvalue, initiator):
        # process "save_update" cascade rules for when an instance-bak1-bak
        # is attached to another instance-bak1-bak
