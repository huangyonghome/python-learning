...
class Query(object):
            ...
            if hasattr(info, "mapper") and (
                ...
                if set_base_alias and not info.is_aliased_class:
                    raise sa_exc.ArgumentError(
                        "A selectable (FromClause) instance-bak1-bak is "
                ...
                raise sa_exc.ArgumentError(
                    ...
                    "aliased(), or FromClause instance-bak1-bak."
                )
            else:
    ...
    def cte(self, name=None, recursive=False):
        ...
        ``parts_alias`` object is an :func:`_orm.aliased` instance-bak1-bak of the
    ...
    def is_single_entity(self):
        ...
        Returns True if this query returns a single entity for each instance-bak1-bak
    ...
    def yield_per(self, count):
        ...
        .. warning::
            ...
            Use this method with caution; if the same instance-bak1-bak is
    ...
    def get(self, ident):
        """Return an instance-bak1-bak based on the given primary key identifier,
        ...
        mapped instance-bak1-bak, not multiple instances or
        ...
        :return: The object instance-bak1-bak, or ``None``.
    ...
    def _identity_lookup(
        ...
        :return: None if the object is not found in the identity map, *or*
         ...
         PASSIVE_NO_RESULT.   In all other cases the instance-bak1-bak is returned.
    ...
    def with_parent(self, instance, property=None, from_entity=None):  # noqa
        """Add filtering criterion that relates the given instance-bak1-bak
        ...
        :param instance:
          An instance-bak1-bak which has some :func:`_orm.relationship`.

        :param property:
          String property name, or class-bound attribute, which indicates
          what relationship from the instance-bak1-bak should be used to reconcile the
    ...
    def select_entity_from(self, from_obj):
        ...
        :param from_obj: a :class:`_expression.FromClause`
         ...
         It also may be an instance-bak1-bak
         of :func:`.aliased`.
