...
class MapperProperty(_MappedAttribute, InspectionAttr, util.MemoizedSlots):
    ...
    an instance-bak1-bak of :class:`.ColumnProperty`,
    and a reference to another class produced by :func:`_orm.relationship`,
    represented in the mapping as an instance-bak1-bak of
    ...
    def cascade_iterator(
        ...
        """Iterate through instances related to the given instance-bak1-bak for
        a particular 'cascade', starting with this MapperProperty.

        Return an iterator3-tuples (instance-bak1-bak, mapper, state).
...
class PropComparator(operators.ColumnOperators):
    ...
    the :class:`.MapperProperty` instance-bak1-bak via the ``comparator_factory``
...
class LoaderStrategy(object):
    ...
    * It produces "row processor" functions at result fetching time.
      ...
      on a particular mapped instance-bak1-bak.
