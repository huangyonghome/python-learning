...
class Inspector(object):
    ...
    def __init__(self, bind):
        ...
        :param bind: a :class:`~sqlalchemy.engine.Connectable`,
          which is typically an instance-bak1-bak of
          :class:`~sqlalchemy.engine.Engine` or
          :class:`~sqlalchemy.engine.Connection`.

        For a dialect-specific instance-bak1-bak of :class:`_reflection.Inspector`, see
    ...
    def from_engine(cls, bind):
        ...
        provide a dialect-specific :class:`_reflection.Inspector` instance-bak1-bak,
        which may
    ...
    def get_columns(self, table_name, schema=None, **kw):
        ...
        * ``type`` - the type of this column; an instance-bak1-bak of
    ...
    def reflecttable(
        ...
        :param table: a :class:`~sqlalchemy.schema.Table` instance-bak1-bak.
