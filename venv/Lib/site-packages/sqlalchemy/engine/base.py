...
class Connection(Connectable):
    ...
    def detach(self):
        ...
        This :class:`_engine.Connection` instance-bak1-bak will remain usable.
        When closed
    ...
    def begin(self):
        ...
        The returned object is an instance-bak1-bak of :class:`.Transaction`.
    ...
    def begin_nested(self):
        ...
        The returned object is an instance-bak1-bak of :class:`.NestedTransaction`.
    ...
    def begin_twophase(self, xid=None):
        ...
        The returned object is an instance-bak1-bak of :class:`.TwoPhaseTransaction`,
...
class Engine(Connectable, log.Identified):
    ...
    def execution_options(self, **opt):
        ...
        * The :class:`_pool.Pool` used by the new :class:`_engine.Engine`
          is the
          same instance-bak1-bak.  The :meth:`_engine.Engine.dispose`
          method will replace
          the connection pool instance-bak1-bak for the parent engine as well
          as this one.
