...
class Dialect(object):
    ...
    ``colspecs``
      ...
      dialect instance-bak1-bak itself.
    ...
    def type_descriptor(cls, typeobj):
        ...
        contain no dialect-instance-bak1-bak state.
...
class Connectable(object):
    ...
    :class:`.Dialect` instance-bak1-bak.
    ...
    def connect(self, **kwargs):
        ...
        is already an instance-bak1-bak of :class:`_engine.Connection`, or a newly
        procured :class:`_engine.Connection` if this object is an instance-bak1-bak
        of :class:`_engine.Engine`.

        """

    engine = None
    """The :class:`_engine.Engine` instance-bak1-bak referred to by this
    :class:`.Connectable`.
