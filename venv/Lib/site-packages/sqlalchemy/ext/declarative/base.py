        ...
        for k in list(dict_):
            ...
            # to be mapped, so raise for that.
                ...
                raise exc.InvalidRequestError(
                    ...
                    "for the MetaData instance-bak1-bak when using a "
...
def _declarative_constructor(self, **kwargs):
    ...
    Sets attributes on the constructed instance-bak1-bak using the names and
    values in ``kwargs``.

    Only keys that are present as
    attributes of the instance-bak1-bak's class are allowed. These could be,
