...
def declarative_base(
    ...
    :param metadata:
      An optional :class:`~sqlalchemy.schema.MetaData` instance-bak1-bak.  All
      :class:`~sqlalchemy.schema.Table` objects implicitly declared by
      subclasses of the base will share this MetaData.  A MetaData instance-bak1-bak
      will be created if none is provided.  The
      :class:`~sqlalchemy.schema.MetaData` instance-bak1-bak will be available via the
    ...
    :param constructor:
      ...
      fields and relationships to an instance-bak1-bak.  If ``None`` is supplied,
