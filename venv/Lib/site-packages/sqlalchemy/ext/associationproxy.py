...
def association_proxy(target_collection, attr, **kw):
    ...
    The returned value is an instance-bak1-bak of :class:`.AssociationProxy`.
    ...
    :param attr: Attribute on the associated instance-bak1-bak or instances we'll
      proxy for.
    ...
    :param creator: optional.
      ...
      the 'value' for the new instance-bak1-bak.  For dict types, two arguments are
...
class AssociationProxy(interfaces.InspectionAttrInfo):
    ...
    def __init__(
        ...
        :param creator: Optional. When new items are added to this proxied
          ...
          new instance-bak1-bak.  For dict types, two arguments are passed:
          key and value.
        ...
        :param getset_factory: Optional.  Proxied attribute access is
          ...
          abstract type of the underlying collection and this proxy instance-bak1-bak.
    ...
    def for_class(self, class_, obj=None):
        ...
        This returns an instance-bak1-bak of :class:`.AssociationProxyInstance` that
        ...
        :param obj: optional, an instance-bak1-bak of the class that is required
...
class AssociationProxyInstance(object):
    ...
    in terms of a specific class or instance-bak1-bak of a class, i.e. when it is
    ...
    def for_proxy(cls, parent, owning_class, parent_instance):
        ...
        try:
            ...
            # return an "ambiguous" instance-bak1-bak that will work on a per-object
            # basis
    ...
    def get(self, obj):
        ...
        if self.scalar:
            ...
            try:
                # If the owning instance-bak1-bak is reborn (orm session resurrect,
...
class AmbiguousAssociationProxyInstance(AssociationProxyInstance):
    ...
    def _non_canonical_get_for_object(self, parent_instance):
        ...
        # is a proxy with generally only instance-bak1-bak-level functionality
        return self
