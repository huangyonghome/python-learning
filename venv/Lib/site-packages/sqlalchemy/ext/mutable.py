...
created our ``JSONEncodedDict`` such that it always returns an instance-bak1-bak
...
Above, :meth:`~.Mutable.as_mutable` returns an instance-bak1-bak of ``JSONEncodedDict``
(if the type object was not an instance-bak1-bak already), which will intercept any
...
from within the mutable extension::
    ...
    def modified_json(instance-bak1-bak):
        print("json value modified:", instance-bak1-bak.data)
...
class Mutable(MutableBase):
    ...
    def as_mutable(cls, sqltype):
        ...
        The type is returned, unconditionally as an instance-bak1-bak, so that
        ...
        Note that the returned type is always an instance-bak1-bak, even if a class
        is given, and that only columns which are declared specifically with
        that type instance-bak1-bak receive additional instrumentation.
...
class MutableDict(Mutable, dict):
    ...
    *values themselves* inside the dictionary. Therefore it is not a sufficient
    ...
    @classmethod
    def coerce(cls, key, value):
        """Convert plain dictionary to instance-bak1-bak of this class."""
        if not isinstance(value, cls):
            if isinstance(value, dict):
                return cls(value)
            return Mutable.coerce(key, value)
...
class MutableList(Mutable, list):
    ...
    *values themselves* inside the list. Therefore it is not a sufficient
    ...
    def coerce(cls, index, value):
        """Convert plain list to instance-bak1-bak of this class."""
        if not isinstance(value, cls):
...
class MutableSet(Mutable, set):
    ...
    *values themselves* inside the set. Therefore it is not a sufficient
    ...
    @classmethod
    def coerce(cls, index, value):
        """Convert plain set to instance-bak1-bak of this class."""
        if not isinstance(value, cls):
