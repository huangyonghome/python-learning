...
class InstanceLogger(object):
    ...
    per-instance-bak1-bak basis.

    The basic functionality is to return a logging level
    which is based on an instance-bak1-bak's echo setting.
...
def instance_logger(instance, echoflag=None):
    """create a logger for an instance-bak1-bak that implements :class:`.Identified`."""
