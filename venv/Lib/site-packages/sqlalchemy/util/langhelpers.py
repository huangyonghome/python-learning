...
def as_interface(obj, cls=None, methods=None, required=None):
    """Ensure basic interface compliance for an instance-bak1-bak or dict of callables.
    ...
    obj
      A type, instance-bak1-bak, or dictionary of callables.
    cls
      Optional, a type.  All public methods of cls are considered the
      interface.  An ``obj`` instance-bak1-bak of cls will always pass, ignoring
      ``required``..
    methods
...
class group_expirable_memoized_property(object):
    ...
    def expire_instance(self, instance):
        """Expire all memoized properties for *instance-bak1-bak*."""
...
def duck_type_collection(specimen, default=None):
    """Given an instance-bak1-bak or class, guess if it is or is acting as one of
...
class hybridmethod(object):
    """Decorate a function as cls- or instance-bak1-bak- level."""
...
class symbol(object):
    ...
    Repeated calls of symbol('name') will all return the same instance-bak1-bak.
...
def set_creation_order(instance):
    """Assign a '_creation_order' sequence to the given instance-bak1-bak.
