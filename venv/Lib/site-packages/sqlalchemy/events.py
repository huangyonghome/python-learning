...
class DDLEvents(event.Events):
    ...
    def column_reflect(self, inspector, table, column_info):
        ...
        by :meth:`.reflection.Inspector.get_columns`:
            ...
            * ``type`` - the type of this column, which should be an instance-bak1-bak
        ...
        ...or with a specific :class:`_schema.Table` instance-bak1-bak using
...
class ConnectionEvents(event.Events):
    ...
    class or instance-bak1-bak, such as an :class:`_engine.Engine`, e.g.::
    ...
    .. note:: :class:`_events.ConnectionEvents` can be established on any
       ...
       four scopes will fire off for a given instance-bak1-bak of
       ...
       class or to an instance-bak1-bak of :class:`_engine.Engine`
       *after* the instantiation
       of a dependent :class:`_engine.Connection` instance-bak1-bak will usually
       *not* be available on that :class:`_engine.Connection` instance-bak1-bak.
       The newly
       added listeners will instead take effect for
       :class:`_engine.Connection`
       instances created subsequent to those event listeners being
       established on the parent :class:`_engine.Engine` class or instance-bak1-bak.
    ...
    def before_execute(self, conn, clauseelement, multiparams, params):
        ...
        :param clauseelement: SQL expression construct, :class:`.Compiled`
         instance-bak1-bak, or string statement passed to
    ...
    def dbapi_error(
        ...
        This event is called with the DBAPI exception instance-bak1-bak
    ...
    def handle_error(self, exception_context):
        ...
        incompatibility, the sole argument received is an instance-bak1-bak of
        ...
        * Establishing or disabling whether a connection or the owning
        ...
        modifier and returning the new exception instance-bak1-bak from the
        ...
        a handler returns ``None``, the previous exception instance-bak1-bak,
