...
class Rule(RuleFactory):
    ...
    `defaults`
        ...
        disabled on the `Map` instance-bak1-bak this will only affect the URL
        generation.
    ...
    def get_empty_kwargs(self):
        ...
        instance-bak1-bak of ``Rule``, following the initial ``self.rule`` value which
...
class Map(object):
    ...
    `Map` instance-bak1-bak since those affect all rules, others are just defaults
...
class MapAdapter(object):
    ...
    def match(
        ...
        - you receive a `RequestRedirect` exception with a `new_url`
          ...
          You can use the `RequestRedirect` instance-bak1-bak as response-like object
    ...
    def build(
        ...
        charset defined on the map instance-bak1-bak.
