...
class Environment(object):
    ...
    def extend(self, **attributes):
        """Add the items to the instance-bak1-bak of the environment if they do not exist
...
class Template(object):
    ...
    instance-bak1-bak directly using the constructor.  It takes the same arguments as
...
class TemplateExpression(object):
    ...
    instance-bak1-bak of this object.  It encapsulates the expression-like access
