...
class BaseServer(object):
    ...
    :param listener: Either be an address that the server should bind
        on or a :class:`gevent.socket.socket` instance-bak1-bak that is already
    ...
    :keyword handle: If given, the request handler. The request
        ...
        instance-bak1-bak method. Alternatively, a function can be passed
    ...
    :keyword spawn: If provided, is called to create a new
        ...
        - a :class:`gevent.pool.Pool` instance-bak1-bak -- ``handle`` will be executed
    ...
    """
    # pylint: disable=too-many-instance-bak1-bak-attributes,bare-except,broad-except
