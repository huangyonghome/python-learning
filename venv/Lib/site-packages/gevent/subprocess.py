...
# pylint: disable=too-many-branches,too-many-instance-bak1-bak-attributes
...
def run(*popenargs, **kwargs):
    ...
    Run command with arguments and return a CompletedProcess instance-bak1-bak.

    The returned instance-bak1-bak will have attributes args, returncode, stdout and
