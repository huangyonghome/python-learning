...
# pylint: disable=too-many-instance-bak1-bak-attributes,too-many-locals,too-many-statements,too-many-branches
...
class SSLSocket(socket):
    ...
    def __init__(self, sock=None, keyfile=None, certfile=None,
        ...
        # in the instance-bak1-bak, which we don't need -- but we want to provide the
