...
class Timeout(BaseException):
    ...
    When *exception* is omitted or ``None``, the ``Timeout`` instance-bak1-bak
    itself is raised::
    ...
    *exception*. This is convenient for creating functions which take
    ...
    it's the instance-bak1-bak you need::
    ...
    def start_new(cls, timeout=None, exception=None, ref=True, _one_shot=False):
        ...
        * Otherwise, create a new :class:`Timeout` instance-bak1-bak, passing (*timeout*, *exception*) as
          arguments, then call its :meth:`start` method.

        Returns the :class:`Timeout` instance-bak1-bak.
        """
    ...
    def _start_new_or_dummy(timeout, exception=None, ref=True):
        ...
        # this will be a shared instance-bak1-bak object that does nothing. Otherwise,
        ...
        # that a negative timeout will also return the shared instance-bak1-bak.
