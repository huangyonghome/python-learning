...
def all_local_dicts_for_greenlet(greenlet):
    ...
    :return: A list of ((type, id), {}) pairs, where the first element
      ...
      instance-bak1-bak dictionary, as seen from this greenlet.
...
class local(object):
    ...
    def __getattribute__(self, name): # pylint:disable=too-many-return-statements
        ...
        # a None for the instance-bak1-bak argument could mess us up here.
        ...
        if name in dct:
            ...
            # (defines just __get__), then the instance-bak1-bak wins. If it's not a
            # descriptor at all (doesn't have __get__), the instance-bak1-bak wins.
