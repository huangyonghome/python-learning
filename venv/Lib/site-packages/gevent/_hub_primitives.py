...
def wait_on_objects(objects=None, timeout=None, count=None):
    ...
    - :class:`gevent.Greenlet` instance-bak1-bak
    - :class:`gevent.event.Event` instance-bak1-bak
    - :class:`gevent.lock.Semaphore` instance-bak1-bak
    - :class:`gevent.subprocess.Popen` instance-bak1-bak
...
# Suitable to be bound as an instance-bak1-bak method
