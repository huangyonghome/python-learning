...
WSGI work is handled by :class:`WSGIHandler` --- a new instance-bak1-bak is
...
class WSGIHandler(object):
    ...
    :class:`WSGIServer` instance-bak1-bak through a keyword argument at
    construction time.
    ...
    """
    # pylint:disable=too-many-instance-bak1-bak-attributes
    ...
    # request headers, instance-bak1-bak of MessageClass (gunicorn uses hasattr
...
class LoggingLogAdapter(object):
    ...
    .. versionchanged:: 1.1b6
       ...
       logger instance-bak1-bak. This permits using custom :class:`~logging.Logger`
...
# instance-bak1-bak of collections.MutableMapping; UserDict.UserDict isn't.)
...
class SecureEnviron(Environ):
    ...
    For debugging, each instance-bak1-bak can have its *secure_repr* attribute
    ...
    *default_whitelist_keys*, respectively::
    ...
    We can turn it off entirely for the instance-bak1-bak::
...
class WSGIServer(StreamServer):
    ...
    :keyword log: If given, an object with a ``write`` method to which
        ...
        (If you pass a :class:`~logging.Logger` instance-bak1-bak, or in
    ...
    #: but this can be customized in a subclass or per-instance-bak1-bak
    ...
    def handle(self, sock, address):
        """
        Create an instance-bak1-bak of :attr:`handler_class` to handle the request.
