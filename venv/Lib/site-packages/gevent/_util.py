...
class Lazy(object):
    ...
    difference is the function value is assigned to the instance-bak1-bak
...
class readproperty(object):
    ...
    when the property is assigned to, it is cached in the instance-bak1-bak
    and the function is not called on that instance-bak1-bak again.
    """
