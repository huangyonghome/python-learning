...
class AsyncResult(AbstractLinkable): # pylint:disable=undefined-variable
    ...
    instead of :meth:`wait`. An :class:`AsyncResult` instance-bak1-bak cannot be reset.
    ...
    @property
    def exception(self):
        """Holds the exception instance-bak1-bak passed to :meth:`set_exception` if :meth:`set_exception` was called.
        Otherwise ``None``."""
        if self._exc_info:
    ...
    def get(self, block=True, timeout=None):
        ...
        If this instance-bak1-bak already holds a value or an exception, return  or raise it immediately.
        ...
        :keyword bool block: If set to ``False`` and this instance-bak1-bak is not ready,
    ...
    def wait(self, timeout=None):
        """Block until the instance-bak1-bak is ready.

        If this instance-bak1-bak already holds a value, it is returned immediately. If this
        instance-bak1-bak already holds an exception, ``None`` is returned immediately.
