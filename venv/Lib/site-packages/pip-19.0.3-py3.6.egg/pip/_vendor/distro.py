...
class cached_property(object):
    ...
    def __get__(self, obj, owner):
        assert obj is not None, 'call {} on an instance-bak1-bak'.format(self._fname)
...
class LinuxDistribution(object):
    ...
    This package creates a private module-global instance-bak1-bak of this class with
    default initialization arguments, that is used by the
    `consolidated accessor functions`_ and `single source accessor functions`_.
    By using default initialization arguments, that module-global instance-bak1-bak
    ...
    def __init__(self,
        ...
        available data sources, and stores that in private instance-bak1-bak attributes.
        Subsequent access to the information items uses these private instance-bak1-bak
        ...
        * ``include_name`` (bool): Controls whether uname command output is
        ...
        Public instance-bak1-bak attributes:
        ...
        * filepath: Path name of the distro release file.
        ...
        try:
            with open(filepath) as fp:
                # Only parse the first line. For instance-bak1-bak, on SLES there
