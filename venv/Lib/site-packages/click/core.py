...
class Context(object):
    ...
    :param token_normalize_func: an optional function that is used to
                                 ...
                                 etc.).  This for instance-bak1-bak can be used to
                                 implement case insensitive behavior.
    :param color: controls if the terminal supports ANSI colors or not.  The
                  default is autodetection.  This is only needed if ANSI
                  codes are used in texts that Click prints which is by
                  default not the case.  This for instance-bak1-bak would affect
                  help output.
    ...
    def meta(self):
        ...
        The keys are supposed to be unique dotted strings.  For instance-bak1-bak
    ...
    def call_on_close(self, f):
        ...
        resource handling to the script execution.  For instance-bak1-bak, file objects
    ...
    def ensure_object(self, object_type):
        ...
        new instance-bak1-bak of `object_type` if it does not exist.
        """
...
class BaseCommand(object):
    ...
    For instance-bak1-bak, this can be used to bridge Click and other systems like
    argparse or docopt.

    Because base commands do not implement a lot of the API that other
    parts of Click take for granted, they are not supported for all
    operations.  For instance-bak1-bak, they cannot be used with the decorators
    ...
    def main(
        ...
        **extra
        ...
        This method is also available by directly calling the instance-bak1-bak of
        a :class:`Command`.
...
class Group(MultiCommand):
    ...
    def command(self, *args, **kwargs):
        ...
        immediately registers the created command with this instance-bak1-bak by
