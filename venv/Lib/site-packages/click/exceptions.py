...
class BadParameter(UsageError):
    ...
    Click will attach contextual information to it (for instance-bak1-bak, which
    parameter it is).
...
class BadOptionUsage(UsageError):
    ...
    was incorrect.  This is for instance-bak1-bak raised if the number of arguments
...
class BadArgumentUsage(UsageError):
    ...
    was incorrect.  This is for instance-bak1-bak raised if the number of values
