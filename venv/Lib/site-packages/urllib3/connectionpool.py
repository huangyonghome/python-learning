...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    :param timeout:
        ...
        or an instance-bak1-bak of :class:`urllib3.util.Timeout` which gives you more
    ...
    def _make_request(self, conn, method, url, timeout=_Default, chunked=False,
        ...
        :param timeout:
            ...
            the socket connect and the socket read, or an instance-bak1-bak of
    ...
    def urlopen(self, method, url, body=None, headers=None, retries=None,
        ...
        :param timeout:
            ...
            request. It may be a float (in seconds) or an instance-bak1-bak of
...
def connection_from_url(url, **kw):
    """
    Given a url, return an :class:`.ConnectionPool` instance-bak1-bak of its host.

    This is a shortcut for not having to parse out the scheme, host, and port
    of the url before creating an :class:`.ConnectionPool` instance-bak1-bak.
